          ...
          <div className="hero-info">
            <div className="info-icons">
              ...
              <Link
                ...
                exact="true"
                key="contact"
                className="info-link animate__animated animate__headShake animate__delay-5s"
              >
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              <div>
                <a
                  href="https://docs.google.com/document/d/1OGazad03DLz0z8uikpQDYadH3D9tM4UHCnqLqhqo9D0/edit?usp=sharing"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
