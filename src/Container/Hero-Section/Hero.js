    ...
    return (
            ...
            <div className="Hero animate__animated animate__fadeIn">
                ...
                <div className="hero-text ">
                    <div>
                    <p className="hero-main ">BREEANA PAYTON</p>
                    ...
                    <div className="hero-social-links">
                        <a href="https://github.com/PaytonDev" className="social-link" target="_blank" rel="noreferrer">
                            ...
                            <a href="https://www.linkedin.com/in/breeana-payton/" className="social-link" target="_blank" rel="noreferrer"> 
                                <button className="hero-button lifting-effect">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#FDF0D5" className="bi bi-linkedin" viewBox="0 0 16 16">
                ...
                <div className="hero-info">
                    <div className="info-icons">
                        ...
                        <div>
                            <a href="https://docs.google.com/document/d/1SgLPZmhQmgbMM05Ic4K9zIJTSEXhyi3qgkVWoZa5Bwg/edit?usp=sharing" target="_blank" rel="noreferrer">
